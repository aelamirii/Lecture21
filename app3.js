...
// SHopping List 1 Controller with undefined Items count
...
//  Shopping List 2 with limited Items count to 3
...
function ShoppingListService(maxItems) {
  ...
  service.addItem = function (itemName, itemQuantity) {
    ...
    )
    {
      ...
      throw new Error("Items count ("+ maxItems +") was reached");
    }
